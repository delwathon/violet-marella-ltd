...
class StoreSale extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($sale) {
            if (empty($sale->receipt_number)) {
                $sale->receipt_number = 'STORE-' . date('Ymd') . '-' . strtoupper(Str::random(6));
            }
    ...
    {
        return $this->hasMany(StoreSaleItem::class, 'store_sale_id');
    }
    ...
    {
        return $this->hasMany(StorePayment::class, 'store_sale_id');
    }
    ...
    {
        return $query->where('store_customer_id', $customerId);
    }
