...
class SalesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Sale::with(['customer', 'staff', 'saleItems']);
        ...
        $todaySales = Sale::completed()->whereDate('sale_date', Carbon::today())->sum('total_amount');
        $thisMonthSales = Sale::completed()
            ->whereBetween('sale_date', [Carbon::now()->startOfMonth(), Carbon::now()])
            ->sum('total_amount');
        $totalTransactions = Sale::completed()->count();
        
        return view('pages.lounge.sales.index', compact(
            'user',
            'sales',
            'totalSales',
            'todaySales',
    ...
    public function today(Request $request)
    {
        ...
        // Today's statistics
        $todayTotal = Sale::completed()->whereDate('sale_date', Carbon::today())->sum('total_amount');
        $todayCount = Sale::completed()->whereDate('sale_date', Carbon::today())->count();
        ...
        return view('pages.lounge.sales.today', compact(
            'user',
            'sales',
            'todayTotal',
            'todayCount',
    ...
    public function show($id)
    {
        ...
        return view('pages.lounge.sales.show', compact('user', 'sale'));
    }
    ...
    {
        $query = Sale::with(['customer', 'staff']);
