...
<div class="content-area">
    ...
    <form action="{{ route('anire-craft-store.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img id="imagePreview" 
                                 src="{{ $category->image ? asset('storage/' . $category->image) : asset('assets/images/no-image.png') }}" 
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            <strong class="float-end">{{ $category->products_count }}</strong>
                        </div>
                        <div class="mb-2">
                            <small class="text-muted">Active Products:</small>
                            <strong class="float-end text-success">{{ $category->active_products_count }}</strong>
                        </div>
                        <div>
                            <small class="text-muted">Created:</small>
                            <strong class="float-end">{{ $category->created_at->format('M d, Y') }}</strong>
                        </div>
                    </div>
                </div>
