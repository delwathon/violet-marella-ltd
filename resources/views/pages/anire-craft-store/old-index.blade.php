                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <!-- Example rows, more can be added -->
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-semibold">Birthday Card Set</div>
                                                <small class="text-muted">Assorted birthday cards</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td><code>BCS-002</code></td>
                                    <td>Cards</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-semibold">Anniversary Flowers</div>
                                                <small class="text-muted">Fresh flower arrangements</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td><code>AF-003</code></td>
                                    <td>Flowers</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="product-image me-3">
                                                <i class="fas fa-teddy-bear text-info"></i>
                                            </div>
                                            <div>
                                                <div class="fw-semibold">Teddy Bear Collection</div>
                                                <small class="text-muted">Soft plush toys</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td><code>TBC-004</code></td>
                                    <td>Toys</td>
                ...
                <div class="card-body">
                    ...
                    <div class="alert-item">
                        <div class="d-flex align-items-center">
                            <i class="fas fa-exclamation-triangle text-warning me-2"></i>
                            <div class="flex-grow-1">
                                <div class="fw-semibold">Wedding Cards</div>
                                <small class="text-muted">Only 8 items left</small>
                            </div>
                        </div>
                    </div>
                </div>
