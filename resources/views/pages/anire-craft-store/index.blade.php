                        ...
                        <div class="card border-primary">
                            <div class="card-body p-3">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="{{ route('anire-craft-store.products.create') }}" class="btn btn-sm btn-primary">
                                        <i class="fas fa-plus"></i> Add New Product
                                    </a>
                                    <a href="{{ route('anire-craft-store.products.index') }}" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="card border-success">
                            <div class="card-body p-3">
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ route('anire-craft-store.customers.create') }}" class="btn btn-sm btn-outline-success">
                                        <i class="fas fa-user-plus"></i> Add Customer (Full)
                                    </a>
                                    <a href="{{ route('anire-craft-store.customers.index') }}" class="btn btn-sm btn-outline-success">
                    ...
                    <div class="col-md-6">
                        <div class="card border-info">
                            <div class="card-body p-3">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="{{ route('anire-craft-store.categories.create') }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-plus"></i> Add Category
                                    </a>
                                    <a href="{{ route('anire-craft-store.categories.index') }}" class="btn btn-sm btn-outline-info">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('anire-craft-store.sales.index') }}" class="btn btn-sm btn-outline-primary">
            ...
            <div class="modal-body">
                <form id="quickCustomerForm">
                    ...
                    <div class="alert alert-info">
                        <small><i class="fas fa-info-circle"></i> For more details, use the <a href="{{ route('anire-craft-store.customers.create') }}" target="_blank">full customer form</a></small>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="lowStockModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <a href="{{ route('anire-craft-store.products.index') }}?stock_status=low" class="btn btn-primary">
...
<div class="modal fade" id="dailySalesModal" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <a href="{{ route('anire-craft-store.sales.today') }}" class="btn btn-primary">
                    <i class="fas fa-chart-bar"></i> Full Reports
                </a>
            </div>
        </div>
