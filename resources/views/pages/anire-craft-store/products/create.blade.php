...
<div class="content-area">
    ...
    <form action="{{ route('anire-craft-store.products.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="store_category_id" class="form-select @error('store_category_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('store_category_id') == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <small class="text-muted">
                                    <a href="{{ route('anire-craft-store.categories.create') }}" target="_blank">Add new category</a>
                                </small>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="unit" class="form-control @error('unit') is-invalid @enderror" 
                                       value="{{ old('unit', 'piece') }}" placeholder="e.g., piece, kg, liter">
                                @error('unit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="track_stock" 
                                           id="trackStock" {{ old('track_stock', true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3" id="stockFields">
                            ...
                            <div class="col-md-4 mb-3" id="minStockField">
                            ...
                            <div class="col-md-4 mb-3" id="maxStockField">
...
document.getElementById('trackStock').addEventListener('change', function() {
    ...
    const maxStockField = document.getElementById('maxStockField');
    
    if (this.checked) {
        stockFields.style.display = 'block';
        minStockField.style.display = 'block';
        maxStockField.style.display = 'block';
    } else {
        stockFields.style.display = 'none';
        minStockField.style.display = 'none';
        maxStockField.style.display = 'none';
    }
});
</script>
@endpush
