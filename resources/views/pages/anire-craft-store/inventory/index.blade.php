@extends('layouts.app')
@section('title', 'Inventory Management - ' . ($companyProfile['name'] ?? 'Violet Marella Limited'))
@push('styles')
        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('anire-craft-store.inventory.logs') }}" class="btn btn-outline-primary">
    ...
    <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('anire-craft-store.inventory.adjust', $product->id) }}" class="btn btn-outline-primary" title="Adjust Stock">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="{{ route('anire-craft-store.products.show', $product->id) }}" class="btn btn-outline-secondary" title="View Details">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="{{ route('anire-craft-store.inventory.logs') }}" class="btn btn-sm btn-outline-primary w-100">
                        View All Logs
                    </a>
                </div>
            </div>
