@extends('layouts.app')
@section('title', 'Low Stock Alert - ' . ($companyProfile['name'] ?? 'Violet Marella Limited'))
@push('styles')
...
function generatePurchaseOrder() {
    ...
    window.location.href = `{{ route('anire-craft-store.inventory.purchase-order') }}?ids=${ids}`;
}

function exportLowStock() {
    window.location.href = '{{ route("anire-craft-store.inventory.export") }}?stock_status=low';
}
