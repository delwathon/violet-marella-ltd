@extends('layouts.app')
@section('title', 'Inventory Logs - ' . ($companyProfile['name'] ?? 'Violet Marella Limited'))
@push('styles')
...
<div class="content-area">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('anire-craft-store.inventory.logs') }}">
                <div class="row g-3">
                    <div class="col-md-2">
                    ...
                    <tbody>
                        @forelse($logs as $log)
                            <tr>
                                ...
                                <td>
                                    @if($log->product)
                                        <a href="{{ route('anire-craft-store.products.show', $log->product->id) }}">
                                            {{ $log->product->name }}
                                        </a>
