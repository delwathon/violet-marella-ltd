...
<div class="content-area">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('anire-craft-store.customers.export') }}" class="btn btn-outline-secondary">
                        <i class="fas fa-download"></i> Export
                    </a>
                    <a href="{{ route('anire-craft-store.customers.create') }}" class="btn btn-success">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('anire-craft-store.customers.index') }}">
                <div class="row g-3">
                    <div class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="{{ route('anire-craft-store.customers.show', $customer->id) }}" 
                                           class="btn btn-outline-info" 
                                           title="View Profile">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('anire-craft-store.customers.edit', $customer->id) }}" 
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted py-5">
                                    ...
                                    <p>Try adjusting your filters or <a href="{{ route('anire-craft-store.customers.create') }}">add a new customer</a></p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
