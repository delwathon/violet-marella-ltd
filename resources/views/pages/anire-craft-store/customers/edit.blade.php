...
<div class="content-area">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <div class="d-flex gap-2">
                    <a href="{{ route('anire-craft-store.customers.show', $customer->id) }}" class="btn btn-outline-info">
    ...
    <form action="{{ route('anire-craft-store.customers.update', $customer->id) }}" method="POST">
        @csrf
        @method('PUT')
