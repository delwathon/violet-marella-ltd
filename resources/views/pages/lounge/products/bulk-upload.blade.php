    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card border-primary mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('lounge.products.download-template') }}" class="btn btn-success w-100 mb-3">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('lounge.products.import-csv') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                        @csrf
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button type="button" class="btn btn-outline-secondary" onclick="window.location.href='{{ route('lounge.products.index') }}'">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('lounge.products.export') }}" class="btn btn-outline-primary">
